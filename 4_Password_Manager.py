...
class GUINewUserWindow:
    def __init__(self, window):
        ...
        password_entry = Entry(window, bd = 3, font = ('Times New Roman', 12), textvariable = self.save_password).place(x = 230, y = 150)
...
class GUIReturningUserWindow:
    ...
    def login_frame(self):
        ...
        password_entry = Entry(login_frame, bd = 3, font = ('Times New Roman', 12), \
            textvariable = self.read_password).place(x = 230, y = 150)
    ...
    def dashboard_frame(self):
        ...
        # Header label
        header = Label(dashboard_frame, fg = 'blue4', text = 'Select an option below',\
            font = ('Times New Roman', 18)).place(relx = .5, rely = .1, anchor = CENTER)
    ...
    def view_passwords_frame(self):
        ...
        text.pack(fill = BOTH)
        text.place(x = 50, y = 100, width = 500, height = 200)
    ...
    def add_passwords_frame(self):
        ...
        # Header label
        header = Label(add_passwords_frame, text = 'Add a new password',\
            font = ('Times New Roman', 18)).place(relx = .5, rely = .1, anchor = CENTER)
        ...
        new_password_label = Label(add_passwords_frame, text = 'Password:', font = ('Times New Roman', 12)).place(x = 112, y = 170)
        ...
        back = Button(add_passwords_frame, text = 'Back', bd = '3', width = 7, height = 1, font = ('Times New Roman', 12), \
            command = lambda: [self.dashboard_frame(), self.frame['add_passwords_frame'].destroy()]).place(x = 140, y = 230)
        ...
        finish_new_password = Button(add_passwords_frame, text = 'Save Password', bd = '3', width = 11, height = 1, \
            font = ('Times New Roman', 12), command = self.get_inputs).place(x = 250, y = 230)
